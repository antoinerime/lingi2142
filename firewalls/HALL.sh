...
ip6tables -A INPUT -s fd00:200:7:22::2 -d fd00:200:7:11::1 -j ACCEPT
ip6tables -A OUTPUT -d fd00:200:7:22::2 -j ACCEPT
...
ip6tables -A INPUT -i belnetb -s $SUB2 -j DROP
ip6tables -A FORWARD -i belnetb -s $SUB2 -j DROP
ip6tables -A INPUT -i belnetb -s $SUB3 -j DROP
ip6tables -A FORWARD -i belnetb -s $SUB3 -j DROP
